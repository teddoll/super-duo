...
public class ScoresProvider extends ContentProvider {
    ...
    private static final int MATCHES_WITH_TWO_DATES = 104;
    ...
    private static final String SCORES_BY_TWO_DATES =
            DatabaseContract.scores_table.DATE_COL + " LIKE ? OR " + DatabaseContract.scores_table.DATE_COL + " LIKE ?" ;
    ...
    static UriMatcher buildUriMatcher() {
        ...
        matcher.addURI(authority, "twoDates", MATCHES_WITH_TWO_DATES);
        return matcher;
    }
    ...
    private int match_uri(Uri uri) {
        String link = uri.toString();
        {
            ...
            } else if (link.contentEquals(DatabaseContract.scores_table.buildScoreWithTwoDates().toString())) {
                return MATCHES_WITH_TWO_DATES;
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        switch (match) {
            ...
            case MATCHES_WITH_TWO_DATES:
                retCursor = mOpenHelper.getReadableDatabase().query(
                        DatabaseContract.SCORES_TABLE,
                        projection, SCORES_BY_TWO_DATES, selectionArgs, null, null, sortOrder);
                break;
            case MATCHES_WITH_ID:
                retCursor = mOpenHelper.getReadableDatabase().query(
                        DatabaseContract.SCORES_TABLE,
